def import_pymb_magic():
    ...
    from IPython.core.magic import (
        magics_class, Magics, cell_magic, line_magic, MagicsManager)
    from IPython.core.magic_arguments import (
        argument, kwds, defaults, magic_arguments, parse_argstring)
    from IPython.core.display import display_javascript
    import PyMB

    # turn on C++ highlighting for PyMB cells
    display_javascript(
        "IPython.config.cell_magic_highlight['magic_clike'] =" +
        "{'reg':[/^%%PyMB/]};", raw=True)
    ...
    class PyMBMagics(Magics):
        ...
        @argument('-NO_WRAP', '--NO_WRAP_OBJ_FUN',
                  dest='WRAP', action='store_false',
        ...
        def PyMB(self, line, cell):
            ...
            # compile model
            model.compile(codestr=code, output_dir=args.OUTPUT_DIR,
                          cc=args.CCOMPILER, R=args.R_DIR,
                          TMB=args.TMB_DIR, LR=args.R_LIB,
